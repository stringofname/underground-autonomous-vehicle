...
class Node:
    def __init__(self, x, y):
        ...
        self.parent = None
        self.cost = 0
def rrt(start, goal, obstacles,p, max_iter=1000, step_size=10):
...
def average_steps(start, goal, obstacles, p,step_size, trials=50):
    total_steps = 0
    for _ in range(trials):
        steps= rrt(start, goal, obstacles, p,step_size=step_size)
...
start = (10, 10)
goal = (90, 90)
obstacles = [(50, 50, 10), (30, 70, 10)]

# Test different step sizes and calculate average steps
average_results = []

for i in range(1,10,1):
    avg_steps = average_steps(start, goal, obstacles,i/10, 10)
    average_results.append((i/10, avg_steps))
    print(f"p: {i/10}, Average Steps: {avg_steps}")
